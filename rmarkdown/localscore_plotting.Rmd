...
plot_gwas_per_snp <- function(x){
  ggplot(x, aes(x=pos_cum/10^6, y=correct_fst, color=as.factor(chr))) +
    ...
    coord_cartesian(ylim=c(0, max(x$correct_fst*0.1)), expand = F) +
    xlab("position (Mbp)") +
    ylab("fst") +
    theme_cowplot() +
...
ggsave("/fs/cbsubscb16/storage/rkc/figures/NBS_AI_ls_fst_outlier_scan.png", width = 7.5, height = 1.25, units = "in")
get_cum_pos(NBS_EBS_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/NBS_EBS_ls_fst_outlier_scan.png", width = 7.5, height = 1.25, units = "in")
get_cum_pos(NBS_GOA_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/NBS_GOA_ls_fst_outlier_scan.png", width = 7.5, height = 1.25, units = "in")
get_cum_pos(NBS_SEAK_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/NBS_SEAK_ls_fst_outlier_scan.png", width = 7.5, height = 1.25, units = "in")
get_cum_pos(AI_EBS_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/AI_EBS_ls_fst_outlier_scan.png", width = 7.5, height = 1.25, units = "in")
get_cum_pos(AI_GOA_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/AI_GOA_ls_fst_outlier_scan.png", width = 7.5, height = 1.25, units = "in")
get_cum_pos(AI_SEAK_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/AI_SEAK_ls_fst_outlier_scan.png", width = 7.5, height = 1.25, units = "in")
get_cum_pos(EBS_GOA_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/EBS_GOA_ls_fst_outlier_scan.png", width = 7.5, height = 1.25, units = "in")
get_cum_pos(EBS_SEAK_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/EBS_SEAK_ls_fst_outlier_scan.png", width = 7.5, height = 1.25, units = "in")
get_cum_pos(GOA_SEAK_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/GOA_SEAK_ls_fst_outlier_scan.png", width = 7.5, height = 1.25, units = "in")
```
