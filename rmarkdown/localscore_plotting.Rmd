...
ggsave("/fs/cbsubscb16/storage/rkc/figures/NBS_AI_ls_fst_outlier_scan.png", width = 7.5, height = 1, units = "in")
get_cum_pos(NBS_EBS_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/NBS_EBS_ls_fst_outlier_scan.png", width = 7.5, height = 1, units = "in")
get_cum_pos(NBS_GOA_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/NBS_GOA_ls_fst_outlier_scan.png", width = 7.5, height = 1, units = "in")
get_cum_pos(NBS_SEAK_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/NBS_SEAK_ls_fst_outlier_scan.png", width = 7.5, height = 1, units = "in")
get_cum_pos(AI_EBS_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/AI_EBS_ls_fst_outlier_scan.png", width = 7.5, height = 1, units = "in")
get_cum_pos(AI_GOA_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/AI_GOA_ls_fst_outlier_scan.png", width = 7.5, height = 1, units = "in")
get_cum_pos(AI_SEAK_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/AI_SEAK_ls_fst_outlier_scan.png", width = 7.5, height = 1, units = "in")
get_cum_pos(EBS_GOA_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/EBS_GOA_ls_fst_outlier_scan.png", width = 7.5, height = 1, units = "in")
get_cum_pos(EBS_SEAK_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/EBS_SEAK_ls_fst_outlier_scan.png", width = 7.5, height = 1, units = "in")
get_cum_pos(GOA_SEAK_outSigAll) %>% plot_gwas_per_snp()
ggsave("/fs/cbsubscb16/storage/rkc/figures/GOA_SEAK_ls_fst_outlier_scan.png", width = 7.5, height = 1, units = "in")
```
...
p100_NBS_GOA <- ggplot(NBS_GOA_outSigAll %>% filter(chr == 100), aes(x = pos/10^6, y = ls)) + 
  ...
  theme(axis.title.x = element_blank(),
          ...
          strip.text.x = element_blank())
p100_NBS_GOA
ggsave("/fs/cbsubscb16/storage/rkc/figures/NBS_GOA_ls_fst_outlier_scan_100.png", width = 9, height = 3, units = "in")
...
p100_AI_GOA <- ggplot(AI_GOA_outSigAll %>% filter(chr == 100), aes(x = pos/10^6, y = ls)) + 
  ...
  theme(axis.title.x = element_blank(),
          ...
          strip.text.x = element_blank())
p100_AI_GOA
ggsave("/fs/cbsubscb16/storage/rkc/figures/AI_GOA_ls_fst_outlier_scan_100.png", width = 9, height = 3, units = "in")
...
p100_EBS_GOA <- ggplot(EBS_GOA_outSigAll %>% filter(chr == 100), aes(x = pos/10^6, y = ls)) + 
  ...
  theme(axis.title.x = element_blank(),
          ...
          strip.text.x = element_blank())
p100_EBS_GOA
ggsave("/fs/cbsubscb16/storage/rkc/figures/EBS_GOA_ls_fst_outlier_scan_100.png", width = 9, height = 3, units = "in")
...
p100_GOA_SEAK <- ggplot(GOA_SEAK_outSigAll %>% filter(chr == 100), aes(x = pos/10^6, y = ls)) + 
  ...
  theme(axis.title.x = element_blank(),
          ...
          strip.text.x = element_blank())
p100_GOA_SEAK
ggsave("/fs/cbsubscb16/storage/rkc/figures/GOA_SEAK_ls_fst_outlier_scan_100.png", width =9, height = 3, units = "in")
```
