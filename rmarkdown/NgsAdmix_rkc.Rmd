...
#SBATCH --output=/home/cas399/rkc/log/ngsadmix_R3_1-8_rkc.log
...
BEAGLE=PCAM-PPLA-wholegenome_polymorphic_R3.beagle.gz
MINMAF=0.05
MININD=86
THREADS=16
...
#BIC = https://wikimedia.org/api/rest_v1/media/math/render/svg/9fb26ce833300f98a6df6039624fc7ffaf4ce7fb
  - works best with simple model extract
    - 
  - AIC works better with lots of weak affects
    - what model would be most predictive for new data (sequence data)
