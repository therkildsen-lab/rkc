...
# read in doCounts output for each population
  pop1_df <- read_delim(paste0("/fs/cbsubscb16/storage/rkc/angsd/counts/PCAM-PPLA_",POP1,"_wgph.pos_counts"), col_names = TRUE) %>% select(-totDepth) 
  pop2_df <- read_delim(paste0("/fs/cbsubscb16/storage/rkc/angsd/counts/PCAM-PPLA_",POP2,"_wgph.pos_counts"), col_names = TRUE) %>% select(-totDepth)
```
