...
#SBATCH --output=/home/cas399/rkc/log/ngsF_inbreeding.log
...
cp /fs/cbsubscb16/storage/rkc/angsd/PCAM-PPLA_wgph.glf $WORKDIR

## Run ngsF
/programs/ngsF-1.2.0/ngsF --n_threads 16 --n_ind 183 --n_sites 8016901 --glf PCAM-PPLA_wgph.glf --out PCAM-PPLA_wgph_inbreeding
...
## FIS boxplot
```{r}
inbreeding_raw %>% ggplot(aes(x = factor(Loc,levels = c("NorthBering", "EastBering","GOA","SEAK","AI")), y = ind_mean)) +
