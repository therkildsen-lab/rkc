...
map("worldHires","USA", xlim=c(-180,-140),ylim=c(56,70), col="gray90", fill=TRUE) %>% 
  points(sample_table$StartLonDD, sample_table$StartLatDD, pch=19, col="red", cex=0.5)  #plot my sample sites#plot the region of USA containing all sites 
```
...
alpha = 0.5
size = 3
All_region_pca <- PCA(genome_cov_BSEA, sample_table_BSEA$ABLG, sample_table_BSEA$GeneralLoc, 1, 2, show.ellipse = F, show.line = F, show.label = F, index_exclude=c(94, 95, 103, 106, 107, 109, 110, 118, 119, 120, 121))

ggsave("/fs/cbsubscb16/storage/rkc/figures/BSEA_region_pca.png", BSEA_region_pca, device = "png")
```